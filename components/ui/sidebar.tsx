  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative hidden md:block w-[16rem] bg-transparent transition-[width] duration-200 ease-linear',
...
function SidebarMenuButton({
  ...
  // Only wrap Tooltip when collapsed — avoids TooltipTrigger+Slot+Link nesting
  // breaking clicks while the sidebar is expanded (desktop default).
  const showTooltip =
