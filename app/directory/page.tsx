...
import {
  ...
  Smartphone, Users, Award, CheckCircle, Grid3x3, List, ArrowLeft, LogIn, Mail, Lock
} from "lucide-react";
...
export default function DirectoryPage() {
  ...
  return (
    <>
        ...
        {showLoginOverlay && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white dark:bg-[#1c1c1e] rounded-3xl shadow-2xl max-w-md w-full p-8 overflow-hidden"
            >
              {/* Close Button */}
              <Link
                href="/"
                className="absolute top-4 right-4 p-2 hover:bg-gray-100 dark:hover:bg-[#2c2c2e] rounded-xl transition"
              >
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Please sign in to access the business directory
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-3 w-full px-4 py-3 bg-white dark:bg-[#2c2c2e] border border-gray-200 dark:border-[#38383a] rounded-xl hover:bg-gray-50 dark:hover:bg-[#3a3a3c] transition font-medium text-gray-700 dark:text-gray-200"
                >
                ...
                <Link
                  href="/login"
                  className="flex items-center justify-center gap-3 w-full px-4 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl transition font-medium"
                >
      ...
      {/* Main Content - Only show if logged in or overlay is dismissed */}
