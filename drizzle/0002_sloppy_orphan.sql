...
--> statement-breakpoint
ALTER TABLE "clients" ADD COLUMN "whatsapp_group_id" varchar(100);--> statement-breakpoint
ALTER TABLE "clients" ADD COLUMN "whatsapp_group_link" text;--> statement-breakpoint
ALTER TABLE "employees" ADD COLUMN "photo_url" text;--> statement-breakpoint
ALTER TABLE "employees" ADD COLUMN "national_id_masked" varchar(20);--> statement-breakpoint
ALTER TABLE "employees" ADD COLUMN "interview_score" integer;--> statement-breakpoint
ALTER TABLE "employees" ADD COLUMN "agreements_doc_url" text;--> statement-breakpoint
ALTER TABLE "employees" ADD COLUMN "joining_letter_url" text;--> statement-breakpoint
ALTER TABLE "employees" ADD COLUMN "additional_docs" jsonb;--> statement-breakpoint
ALTER TABLE "audit_logs" ADD CONSTRAINT "audit_logs_operator_id_profiles_id_fk" FOREIGN KEY ("operator_id") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "business_amenities" ADD CONSTRAINT "business_amenities_business_id_businesses_id_fk" FOREIGN KEY ("business_id") REFERENCES "public"."businesses"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "business_reviews" ADD CONSTRAINT "business_reviews_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "business_reviews" ADD CONSTRAINT "business_reviews_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "businesses" ADD CONSTRAINT "businesses_client_id_clients_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."clients"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "project_tasks" ADD CONSTRAINT "project_tasks_assigned_to_profiles_id_fk" FOREIGN KEY ("assigned_to") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "projects" ADD CONSTRAINT "projects_lead_id_profiles_id_fk" FOREIGN KEY ("lead_id") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
