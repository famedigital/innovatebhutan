...
async function updateSession(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://ldrfdkkkvvcznsprbghf.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_p8LfB3Az5Z4Byrw4DrxTsQ_VKijL3WV"), {
        cookies: {
            getAll () {
    ...
    if (!user && !request.nextUrl.pathname.startsWith('/login') && !request.nextUrl.pathname.startsWith('/auth') && !request.nextUrl.pathname.startsWith('/client') && !isPublicPage(request.nextUrl.pathname)) {
